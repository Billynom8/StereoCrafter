...
"    }")
        ...
        self.horizontalLayout_bottom_buttons.addItem(self.horizontalSpacer)
        ...
        self.horizontalLayout_bottom_buttons.addWidget(self.label_status)
        ...
        self.horizontalLayout_bottom_buttons.addItem(self.horizontalSpacer_5)
        ...
        self.gridLayout_9.addLayout(self.horizontalLayout_bottom_buttons, 6, 0, 1, 1)

        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QMenuBar(MainWindow)
        self.menubar.setObjectName(u"menubar")
        self.menubar.setGeometry(QRect(0, 0, 1337, 33))
